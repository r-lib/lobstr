...
sxp(x)
#> [1:0x55f9a364b0e8] <VECSXP[4]> (refs:2+)
#>   [2:0x55f9a39da6c8] <LGLSXP[1]> (refs:2+)
#>   [3:0x55f9a39da508] <INTSXP[1]> (refs:2+)
#>   [4:0x55f9a3a87d10] <REALSXP[100]> (refs:1)
#>   [5:0x55f9a39d9eb0] <STRSXP[1]> (refs:2+)

# Expand "character" to see underlying CHARSXP entries in the global
# string pool
x <- c("banana", "banana", "apple", "banana")
sxp(x)
#> [1:0x55f9a1af4f28] <STRSXP[4]> (refs:2+)
sxp(x, expand = "character")
#> [1:0x55f9a1af4f28] <STRSXP[4]> (refs:2+)
#>   [2:0x55f9a3642e50] <CHARSXP> (refs:2+)
#>   [2:0x55f9a3642e50]
#>   [3:0x55f9a07cb0a8] <CHARSXP> (refs:2+)
#>   [2:0x55f9a3642e50]

# Expand altrep to see underlying data
x <- 1:10
sxp(x)
#> [1:0x55f9a0793930] <INTSXP[10]> (altrep refs:2+)
sxp(x, expand = "altrep")
#> [1:0x55f9a0793930] <INTSXP[10]> (altrep refs:2+)
#>   _class [2:0x55f99b3ec860] <RAWSXP[144]> (refs:2+)
#>     _attrib [3:0x55f9a0649cd0] <LISTSXP> (refs:1)
#>       [4:0x55f99b422928] <SYMSXP: compact_intseq> (refs:2+)
#>       [5:0x55f99b3ee380] <SYMSXP: base> (refs:2+)
#>       [6:0x55f99b4211e8] <INTSXP[1]> (refs:2+)
#>   _data1 [7:0x55f9a1adf9b8] <REALSXP[3]> (refs:1)
#>   _data2 <NILSXP>
...
sxp(e)
#> [1:0x55f9a00f1ba8] <ENVSXP> (refs:2+)
#>   x <PROMSXP>
#>   _enclos [2:0x55f99b3ef688] <ENVSXP: empty> (refs:2+)
sxp(e, expand = "environment")
#> [1:0x55f9a00f1ba8] <ENVSXP> (refs:2+)
#>   x <PROMSXP>
#>   _code [2:0x55f9a192a690] <LANGSXP> (refs:2+)
#>     ...
#>   _env [3:0x55f9a397fbd8] <ENVSXP> (refs:2+)
#>     x [4:0x55f9a0793930] <INTSXP[10]> (altrep refs:2+)
#>     e [1:0x55f9a00f1ba8]
#>     _enclos [5:0x55f9a3cf3750] <ENVSXP> (refs:2+)
#>       DONTSHOW [6:0x55f9a3cf32b8] <CLOSXP> (refs:1)
#>         _formals [7:0x55f99ddfd730] <LISTSXP> (refs:2+)
#>           ...
#>         _body [8:0x55f99ddfd768] <BCODESXP> (refs:2+)
#>           ...
#>         _env [9:0x55f9a3c8c7f8] <ENVSXP> (refs:2+)
#>           ...
#>       TESTONLY [10:0x55f9a3cf3248] <CLOSXP> (refs:1)
#>         _formals [11:0x55f99ddfda40] <LISTSXP> (refs:2+)
#>           ...
#>         _body [12:0x55f99ddfda78] <BCODESXP> (refs:2+)
#>           ...
#>         _env [9:0x55f9a3c8c7f8]
#>       _enclos [13:0x55f9a3c8ca60] <ENVSXP> (refs:2+)
#>         _enclos [14:0x55f99fe1fec0] <ENVSXP> (refs:2+)
#>           ...
#>   _enclos [15:0x55f99b3ef688] <ENVSXP: empty> (refs:2+)
```
